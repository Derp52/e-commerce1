            ...
            <div className='w-full flex flex-col'>
                ...
                <div className='bg-pink-50 flex gap-x-2 h-[40px] text-sm'>
                    <div className='flex flex-1 max-w-[65px] h-full border font-medium text-primary items-center'>
                        ...
                        <div onClick={()=> decreaseAmount(id)}  className='flex-1 h-full flex justify-center items-center cursor-pointer hover:text-red-500'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
                        ...
                        <div onClick={()=> handleIncreaseAmount(id)}  className='flex-1 h-full flex justify-center items-center cursor-pointer hover:text-blue-500'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
